...
<head>
	...
	<form action="veritabaniSatis.php" method="POST">
</head>
<body>
	<div class="wrapper">
...
<div class="alert alert-danger alert-dismissible" role="alert">
                ...
                <span aria-hidden="true">&times;</span>
											...
											<div class="alert-message">
												<strong>Başarılı!</strong> Satım işleminiz başarıyla kaydedildi!
											</div>
										</div>
							<div class="card">
								<div class="card-header">
									<h5 class="card-title">Satış Girişi</h5>
									<h6 class="card-subtitle text-muted">Kripto Para Satışı gerçekleştirdiyseniz buradan giriş yapabilirsiniz.<br><br>
									...
									<form>
										<div class="row">
											<div class="mb-3 col-md-6">
												<label class="form-label" for="coin_id">Satılan Kripto Paranın Kodu:</label>
											...
											<div class="mb-3 col-md-6">
												<label class="form-label" for="satim_miktar">Satım Miktarınız:</label>
												<input type="text" class="form-control" name="satim_miktar"/>
											</div>
										</div>
										<div class="mb-3">
											<label class="form-label" for="satim_fiyat">Sattığınız Fiyat:</label>
											<input class="form-control" name="satim_fiyat"/>
										</div>
										<div class="mb-3">
              ...
              <span class="form-check-label">Bu işlemin geri alınamayacağını,veritabanına kaydedileceğini biliyorum ve kabul ediyorum.</span>
										...
										<input type="submit" class="btn btn-danger" value="Satım Kaydı Ekle"/>
									</form>
								</div>
							</div>
						</div>
